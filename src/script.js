...
const floorRoughnessTexture = textureLoader.load("/textures/grass/color.jpg");
...
const ghost1 = new THREE.PointLight(lightParams.ghost1, 2, 3);
const ghost2 = new THREE.PointLight(lightParams.ghost2, 2, 3);
const ghost3 = new THREE.PointLight(lightParams.ghost3, 2, 3);

scene.add(ghost1, ghost2, ghost3);

gui.addColor(lightParams, "ghost1").onChange((value) => {
  ghost1.color.set(value);
});
gui.addColor(lightParams, "ghost2").onChange((value) => {
  ghost1.color.set(value);
});
gui.addColor(lightParams, "ghost3").onChange((value) => {
  ghost1.color.set(value);
});
